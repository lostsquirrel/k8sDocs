...
[标签选择器](/docs/concepts/overview/working-with-objects/labels/)
...
的标签外。 节点也可能预先就有一些标签标签。 详见
 [常见 标签, 注解和毒点(Taint)](/docs/reference/kubernetes-api/labels-annotations-taints/)
{{< note >}}
...
1. 确保你在使用 [Node authorizer](/docs/reference/access-authn-authz/node/) 和
  _启用了_
